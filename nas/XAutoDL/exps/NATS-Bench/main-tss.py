...
def evaluate_all_datasets(
    ...
    for dataset, xpath, split in zip(datasets, xpaths, splits):
        ...
        elif dataset == "synthetic-cifar10":
            print("Warning: synthetic-cifar10 is not supported for split. Using only train without validation.")
        elif dataset == "Tiny10":
            print("Warning: Tiny10 is not supported for split. The validation set is used as the test set.")
        elif dataset == "synthetic-Tiny10":
            print("Warning: synthetic-Tiny10 is not supported for split. Using only train without validation.")
...
if __name__ == "__main__":
    ...
    parser.add_argument(
        "--splits", type=int, nargs="+", help="Whether to use split validation set."
    )
    parser.add_argument(
        "--hyper",
        type=str,
